 ...
 <div class="row justify-content-center">
  ...
  // Проверка на наличие сообщений об ошибках
    if (isset($_GET['error'])) {
      ...
      ?>
    <form class="form mt-5" method="POST" action="../controllers/Modify.php">
        <h2>Редактировать ученика</h2>
        <div class="form-group">
            <input type="text" name="surname" placeholder="Фамилия" class="form-control mt-2" value="<?php echo $_GET['surname']; ?>" required>
            <input type="text" name="firstName" placeholder="Имя" class="form-control mt-2" value="<?php echo $_GET['firstname']; ?>" required>
            <input type="text" name="secondName" placeholder="Отчество" class="form-control mt-2" value="<?php echo $_GET['secondname']; ?>" required> 
            <input id="date" type="text" name="birthDay" placeholder="День рождения ДД.MM.ГГГГ" value="<?php echo $_GET['birthDate']; ?>" class="form-control mt-2" required 
